...
async def megadl(bot, message):
    ...
    if lmaocheckdis > TG_MAX_FILE_SIZE:
        ...
        if not guessedfilemime.mime:
            ...
            await safone.reply_text(f"**Join @OMG_info! \nThanks For Using Me 😘!**", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🙌 SHARE 🙌", url=f"https://t.me/share/url?url=**Hey%20Guys!%20%20Check%20Out%20@OMG_info's%20Bots%20Channel.%20%20Share%20His%20Bots%20And%20Support%20Him%20%F0%9F%98%89!%20%20Here%20Is%20The%20Bots%20List%20:-%20https://t.me/OMG_info/173**")]]), reply_to_message_id=safone.message_id)
